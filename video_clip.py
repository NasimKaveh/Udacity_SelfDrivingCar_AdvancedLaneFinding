...
def image_process(img):
    ...
    grad = ColorPipeline(img, s_thresh=(170, 255), v_thresh=(50,255)) # 100 instead of 170
    ...
    #out_img shows the sliding window images and result from search_around_poly is to show the line fits with lane boundary 

    out_img, left_fitx, right_fitx, ploty, left_fit, right_fit = fit_polynomial(warped)
    result, left_line_pts, right_line_pts, inner_line_pts = search_around_poly(warped)
    ...
    #cv2.imwrite("output_images/lane+text_" + str(i) +'.jpg' , result)
